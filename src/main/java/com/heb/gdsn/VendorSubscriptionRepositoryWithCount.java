...
public interface VendorSubscriptionRepositoryWithCount extends JpaRepository<VendorSubscription, Integer>{
	 ...
	 */
	Page<VendorSubscription> findByVendorGln(@Param("vendorGln")String vendorGln, Pageable pageRequest);
	 ...
	 * @return A page of vendor subscriptions including record counts.
	 */
	@Query("select v from VendorSubscription v where v.vendorName like :vendorName")
