...
public class AttributeMaintenanceController {
    ...
    public PageableResult<Attribute> getAttributes(HttpServletRequest request, String attributeName, boolean includeCounts, int page, int pageSize){
        ...
        Page<Attribute> result = attributeMaintenanceService.getAttributeMaintenanceTable(pageable, attributeName);
