...
public class ECommerceViewDetails implements java.io.Serializable {
	...
	private ECommerceViewAttributePriorities dinnerTonightTags;
	private ECommerceViewAttributePriorities dinnerTonightProductDescription;
	private ECommerceViewAttributePriorities secondaryProductDescription;
	...
	/**
	 * Returns the secondary product description.
	 *
	 * @return the secondary product description.
	 */
	public ECommerceViewAttributePriorities getSecondaryProductDescription() {
		return secondaryProductDescription;
	}

	/**
	 *  Sets the secondary product description.
	 *
	 * @param secondaryProductDescription the secondary product description.
	 */
	public void setSecondaryProductDescription(ECommerceViewAttributePriorities secondaryProductDescription) {
		this.secondaryProductDescription = secondaryProductDescription;
	}
	/**
	 * Returns the dinner tonight product description.
	 *
	 * @return the dinner tonight product description.
	 */
	public ECommerceViewAttributePriorities getDinnerTonightProductDescription() {
		return dinnerTonightProductDescription;
	}

	/**
	 * Sets the dinner tonight product description.
	 *
	 * @param dinnerTonightProductDescription the dinner tonight product description.
	 */
	public void setDinnerTonightProductDescription(ECommerceViewAttributePriorities dinnerTonightProductDescription) {
		this.dinnerTonightProductDescription = dinnerTonightProductDescription;
	}

	/**
	 * Returns the dinner tonight tags.
	 *
	 * @return the dinner tonight tags.
	 */
	public ECommerceViewAttributePriorities getDinnerTonightTags() {
		return dinnerTonightTags;
	}

	/**
	 * Sets the dinner tonight tags.
	 *
	 * @param dinnerTonightTags the dinner tonight tags.
	 */
	public void setDinnerTonightTags(ECommerceViewAttributePriorities dinnerTonightTags) {
		this.dinnerTonightTags = dinnerTonightTags;
	}
