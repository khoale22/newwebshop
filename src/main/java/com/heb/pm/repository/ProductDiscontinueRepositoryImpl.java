/*
 * ProductDiscontinueRepositoryCustomImpl
 *
...
/**
 * JPA repository implementation for data from the prod_del table for queries without parameters.
 *
 * @author m314029
 * @since 2.0.8
 */
public class ProductDiscontinueRepositoryImpl implements ProductDiscontinueRepositoryDelegate {
	 ...
	 */
	@Override
	public List<ProductDiscontinue> findByDepartment(String department, StatusFilter statusFilter,
													 Pageable pageRequest) {
		return this.getList(department, null, pageRequest, statusFilter);
	}
	 ...
	 */
	@Override
	public List<ProductDiscontinue> findByDepartmentAndSubDepartment(String department,
																	 String subDepartment,
																	 StatusFilter statusFilter,
																	 Pageable pageRequest) {
		return this.getList(department, subDepartment, pageRequest, statusFilter);
	}

	/**
	 * Return a list of product discontinue data based on search criteria.
	 *
	 * @param department The department to search by.
	 * @param subDepartment The sub department to search by.
	 * @param pageRequest Page information to include page, page size, and sort order.
	...
	private List<ProductDiscontinue> getList(String department, String subDepartment, Pageable pageRequest,
											 StatusFilter statusFilter){
