...
public class ProductECommerceViewController {
    ...
    private static final String URL_FIND_WARNINGS_DINNER_TONIGHT = "/findWarningsDinnerTonight";
    ...
    private static final String FIND_DINNER_TONIGHT_PRODUCT_DESCRIPTION = "findDinnerTonightProductDescription";
    private static final String FIND_TAGS = "findTags";
    private static final String FIND_DINNER_TONIGHT_TAGS = "findDinnerTonightTags";
    private static final String URL_FIND_DIRECTIONS = "/findDirections";
    private static final String URL_FIND_DIRECTIONS_DINNER_TONIGHT = "/findDirectionsDinnerTonight";
    ...
    private static final String URL_FIND_ALL_INGREDIENT_ATTRIBUTE_DINNER_TONIGHT =
            "/findAllIngredientAttributePrioritiesForDinnerTonight";
    private static final String GET_SPECIFICATION_INFORMATION = "/getSpecificationInformation";
    private static final String GET_DINNER_TONIGHT_INFORMATION = "/getDinnerTonightInformation";
    private static final String GET_DINNER_TONIGHT_SPECIFICATION = "/getDinnerTonightSpecification";
    private static final String CHECK_FULFILLMENT = "/checkFulfillment";
    private static final String UPDATE_ECOMMERCE_VIEW_FOR_DINNER_TONIGHT = "/updateECommerceViewForDinnerTonight";
    private static final String URL_FIND_INGREDIENTS_DINNER_TONIGHT = "/findIngredientsForDinnerTonight";
    ...
    private static final String SECONDARY_PRODUCT_DESCRIPTION_KEY = "secondaryProductDescription";
    ...
    private static final String GET_DINNER_TONIGHT_INFORMATION_LOG_MESSAGE = "User %s from IP %s has requested get dinner tonight information";
    private static final String GET_DINNER_TONIGHT_SPECIFICATION_LOG_MESSAGE = "User %s from IP %s has requested get dinner tonight specification.";
    ...
    private static final String FIND_WARNINGS_DINNER_TONIGHT_MESSAGE = "User %s from IP %s requested to find warnings for Dinner Tonight";
    ...
    private static final String FIND_DINNER_TONIGHT_PRODUCT_DESCRIPTION_LOG_MESSAGE = "User %s from IP %s requested to find dinner tonight product description by upc: %s";
    private static final String FIND_TAGS_LOG_MESSAGE = "User %s from IP %s requested to find tags by product id: %s, upc: %s";
    private static final String FIND_DINNER_TONIGHT_TAGS_LOG_MESSAGE = "User %s from IP %s requested to find dinner tonight tags by upc: %s";
    private static final String FIND_DIRECTIONS_MESSAGE = "User %s from IP %s requested to find directions";
    private static final String FIND_DIRECTIONS_DINNER_TONIGHT_MESSAGE = "User %s from IP %s requested to find directions for Dinner Tonight";
    private static final String FIND_INGREDIENTS_MESSAGE = "User %s from IP %s requested to find ingredients";
    private static final String FIND_ALL_INGREDIENT_ATTRIBUTE_MESSAGE_DINNER_TONIGHT = "User %s from IP %s requested to find all " +
            "ingredient attribute priorities for Dinner Tonight";
    ...
    private static final String UPDATE_ECOMMERCE_FOR_SOURCE_27_MESSAGE = "User %s from IP %s requested to update eCommerce view for source 27.";
    ...
    /**
     * Get dinner tonight information by attribute Id.
     *
     ...
     */
    @ViewPermission
    @RequestMapping(method = RequestMethod.GET, value = ProductECommerceViewController.GET_DINNER_TONIGHT_INFORMATION)
    public ECommerceViewAttributePriorities getDinnerTonightInformation(@RequestParam(value = "attributeId") long attributeId,
                                                                        @RequestParam(value = "upc") long upc,
                                                                        HttpServletRequest request) {
        ProductECommerceViewController.logger.info(String.format(ProductECommerceViewController.GET_DINNER_TONIGHT_INFORMATION_LOG_MESSAGE, this.userInfo
                .getUserId(), request.getRemoteAddr()));
        ECommerceViewAttributePriorities returnObject = this.service.getECommerceDataSystemByLogicAttributeAndUpcForDinnerTonight(attributeId, upc);
        return returnObject;
    }

    /**
     * Gets dinner Tonight Specification By Upc.
     *
     * @param productId - The product id
     * @param upc The scan code number
     * @param request The HTTP request that initiated this call.
     * @return ECommerceViewAttributePriorities object
     */
    @ViewPermission
    @RequestMapping(method = RequestMethod.GET, value = ProductECommerceViewController.GET_DINNER_TONIGHT_SPECIFICATION)
    public ECommerceViewAttributePriorities getDinnerTonightSpecification(@RequestParam(value = "productId") long productId, @RequestParam(value = "upc") long upc,
                                                                          HttpServletRequest request) {
        ProductECommerceViewController.logger.info(String.format(ProductECommerceViewController.GET_DINNER_TONIGHT_SPECIFICATION_LOG_MESSAGE, this.userInfo
                .getUserId(), request.getRemoteAddr()));
        ECommerceViewAttributePriorities returnObject = this.service.getDinnerTonightSpecification(productId, upc);
        return returnObject;
    }
    ...
    /**
     * Find the warnings of eCommerceView in Dinner Tonight tab by upc.
     *
     * @param scanCodeId the upc to find.
     * @param request    the http servlet request.
     * @return the eCommerceViewAttributePriorities entity that contains the warnings.
     */
    @ViewPermission
    @RequestMapping(method = RequestMethod.GET, value = ProductECommerceViewController.URL_FIND_WARNINGS_DINNER_TONIGHT)
    public ECommerceViewAttributePriorities getWarningsDinnerTonightByUpc(@RequestParam("scanCodeId") long scanCodeId,
                                                                          HttpServletRequest request) {
        ProductECommerceViewController.logger.info(String.format(ProductECommerceViewController.FIND_WARNINGS_DINNER_TONIGHT_MESSAGE,
                this.userInfo.getUserId(), request.getRemoteAddr()));

        return this.service.getWarningsDinnerTonightByUpc(scanCodeId);
    }
    ...
    /**
     * Find secondary product description by upc.
     *
     ...
     */
    @ViewPermission
    @RequestMapping(method = RequestMethod.GET, value = ProductECommerceViewController.FIND_DINNER_TONIGHT_PRODUCT_DESCRIPTION)
    public Map<String, ECommerceViewAttributePriorities> findDinnerTonightProductDescriptionByUpc(@RequestParam(value = "upc") long upc,
                                                                                                  HttpServletRequest request){
        //Log message.
        ProductECommerceViewController.logger.info(ProductECommerceViewController.FIND_DINNER_TONIGHT_PRODUCT_DESCRIPTION_LOG_MESSAGE, this.userInfo
                .getUserId(), request.getRemoteAddr(), upc);
        Map<String, ECommerceViewAttributePriorities> results = new HashMap<>();
        results.put(PRODUCT_DESCRIPTION_KEY, this.service.findDinnerTonightProductDescriptionByUpc(upc));
        results.put(SECONDARY_PRODUCT_DESCRIPTION_KEY, this.service.findSecondaryProductDescriptionByUpc(upc));
        return results;
    }
    ...
    /**
     * Find dinner to night tags by upc.
     *
     * @param productId the id of product.
     * @param upc the upc.
     * @param request The HTTP request that initiated this call.
     ...
     */
    @ViewPermission
    @RequestMapping(method = RequestMethod.GET, value = ProductECommerceViewController.FIND_DINNER_TONIGHT_TAGS)
    public ECommerceViewAttributePriorities findDinnerTonightTagsByProductIdAndUpc(@RequestParam(value = "productId") long productId, @RequestParam(value = "upc") long upc,HttpServletRequest request){
        //Log message.
        ProductECommerceViewController.logger.info(ProductECommerceViewController.FIND_DINNER_TONIGHT_TAGS_LOG_MESSAGE, this.userInfo
                .getUserId(), request.getRemoteAddr(), upc);
        return this.service.findDinnerTonightTags(productId, upc);
    }
    /**
    ...
    /**
     * Find the directions of eCommerceView in Dinner Tonight tab by upc.
     *
     * @param scanCodeId the upc to find.
     * @param request    the http servlet request.
     * @return the eCommerceViewAttributePriorities entity that contains the directions.
     */
    @ViewPermission
    @RequestMapping(method = RequestMethod.GET, value = ProductECommerceViewController.URL_FIND_DIRECTIONS_DINNER_TONIGHT)
    public ECommerceViewAttributePriorities getDirectionsDinnerTonightByUpc(@RequestParam("scanCodeId") long scanCodeId,
                                                                            HttpServletRequest request) {
        ProductECommerceViewController.logger.info(String.format(ProductECommerceViewController.FIND_DIRECTIONS_DINNER_TONIGHT_MESSAGE,
                this.userInfo.getUserId(), request.getRemoteAddr()));

        return this.service.getDirectionsDinnerTonightByUpc(scanCodeId);
    }
     ...
     *
     * @param product the ECommerceViewAttributePriorities object.
     * @param request  The HTTP request that initiated this call.
     * @return Success message.
     * @throws Exception
     */
    @EditPermission
    @RequestMapping(method = RequestMethod.POST, value = ProductECommerceViewController.UPDATE_ECOMMERCE_VIEW_FOR_DINNER_TONIGHT)
    public ModifiedEntity updateECommerceViewForDinnerTonight(@RequestBody ECommerceViewDetails product, HttpServletRequest request) throws Exception{
        ProductECommerceViewController.logger.info(String.format(ProductECommerceViewController.UPDATE_ECOMMERCE_FOR_SOURCE_27_MESSAGE,
                this.userInfo.getUserId(), request.getRemoteAddr()));
        this.service.updateECommerceViewForDinnerTonight(product, userInfo.getUserId());
     ...
     */
    @ViewPermission
    @RequestMapping(method = RequestMethod.GET, value = ProductECommerceViewController.URL_FIND_INGREDIENTS_DINNER_TONIGHT)
    public ECommerceViewAttributePriorities getIngredientsForDinnerTonight(@RequestParam("productId") long productId,
                                                                           @RequestParam("scanCodeId") long scanCodeId,
                                                                           HttpServletRequest request) {
        ProductECommerceViewController.logger.info(String.format(ProductECommerceViewController.FIND_INGREDIENTS_MESSAGE,
                this.userInfo.getUserId(), request.getRemoteAddr()));

        return this.service.getIngredientForDinnerTonight(productId, scanCodeId);
    }
     ...
     */
    @ViewPermission
    @RequestMapping(method = RequestMethod.GET, value = ProductECommerceViewController.URL_FIND_ALL_INGREDIENT_ATTRIBUTE_DINNER_TONIGHT)
    public List<ECommerceViewAttributePriorities> findAllIngredientAttributePrioritiesForDinnerTonight(@RequestParam("productId") long productId,
                                                                                                       @RequestParam("scanCodeId") long scanCodeId,
                                                                                                       HttpServletRequest request) {
        ProductECommerceViewController.logger.info(String.format(
                ProductECommerceViewController.FIND_ALL_INGREDIENT_ATTRIBUTE_MESSAGE_DINNER_TONIGHT,
                this.userInfo.getUserId(), request.getRemoteAddr()));

        return this.service.findAllIngredientAttributePrioritiesForDinnerTonight(productId, scanCodeId);
    }
    /**
     *  Call the service to save eCommerce data.
     *
