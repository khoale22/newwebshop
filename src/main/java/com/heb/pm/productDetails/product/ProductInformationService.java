...
public class ProductInformationService {
	...
	public void update(ProductInfoParameters productInfoParameters) {
		...
		try {
			this.productManagementServiceClient.updateProductInformation(
					this.getUserEditableUpdatableFieldsForProductManagementService(originalProductMaster, productInfoParameters),
