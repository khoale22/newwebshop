...
public class NutrientStatementController {
	...
	@ViewPermission
	@RequestMapping (method = RequestMethod.GET,value = "checkNLEA16NutrientStatementIsExist")
	public Boolean checkNLEA16NutrientStatementIsExist(@RequestParam("nutrientStatementNumber") Long nutrientStatementNumber,HttpServletRequest request) {
		...
		return nutrientsService.checkNLEA16NutrientStatementIsExist(nutrientStatementNumber);
	}
