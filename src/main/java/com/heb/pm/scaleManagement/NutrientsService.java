...
public class NutrientsService {
	...
	/**
	 *
	 * @param nutrientStatementNumber
	 * @return
	 */
	public Boolean checkNLEA16NutrientStatementIsExist (Long nutrientStatementNumber){
		List<NutrientStatementPanelHeader> nutrientStatementPanelHeaders =
				nutrientStatementPanelHeaderRepository.findBySourceSystemReferenceIdAndStatementMaintenanceSwitchNotAndSourceSystemId(nutrientStatementNumber.toString(),
						...
						NutrientStatementPanelHeader.SRC_SYTEM_ID_17);
		if (nutrientStatementPanelHeaders !=null && nutrientStatementPanelHeaders.size()>0){
			return true;
		}
		return false;
	}
