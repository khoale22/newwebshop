...
public class EPlumApiUtils {
	...
	public EPlumMessage generateEPlumMessage(Long ePlumBatchNumber,
		...
		EPlumMessage toReturn = new EPlumMessage()
				.setPluData(this.createPLUInformation(currentScaleMaintenance, store, currentUpcs))
				.setIngredientData(this.createIngredientInformation(currentScaleMaintenance, store))
				.setNutrientData(this.createNutrientInformation(currentScaleMaintenance, store));
		toReturn.setHeaderData(this.createHeaderInformation(ePlumBatchNumber, store));
		return toReturn;
	}
	 ...
	 * @param store Store
	 * @return Nutrient information of the body of an ePlum message.
	 */
	private String createNutrientInformation(List<ScaleMaintenance> currentScaleMaintenance, Integer store) throws IllegalArgumentException {
		...
		for(ScaleMaintenance currentMaintenance : currentScaleMaintenance){
			...
			if(currentScaleMaintenance.indexOf(currentMaintenance) != 0){
				toReturn.append(EPLUM_MESSAGE_DELIMITER);
			}
	 ...
	 */
	private String getStringFormattedForNutrient(ScaleMaintenanceNutrient nutrient, boolean sendValue, boolean sendPercent) {
		if(nutrient != null) {
	 ...
	 */
	private String getEPlumServingSizeFromScaleMaintenanceNutrient(ScaleMaintenanceNutrientStatement nutrientStatement) {
	 ...
	 * @param currentScaleMaintenance List of authorization/ retail and PLU data to use to retrieve information.
	 * @param store Store
	 * @return Ingredient information of the body of an ePlum message.
	 */
	private String createIngredientInformation(List<ScaleMaintenance> currentScaleMaintenance, Integer store) throws IllegalArgumentException {
		StringBuilder toReturn = new StringBuilder(StringUtils.EMPTY);
		for(ScaleMaintenance currentMaintenance : currentScaleMaintenance){
	 ...
	 * @param store Store
	 * @param currentUpcs
	 * @return PLU information of the body of an ePlum message.
	 */
	private String createPLUInformation(List<ScaleMaintenance> currentScaleMaintenance, Integer store,
	 ...
	 */
	private String createHeaderInformation(Long ePlumBatchNumber, Integer storeNumber) {
