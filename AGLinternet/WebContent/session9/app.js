(function () {
    ...
    function filterDemoCtrl($scope) {
        var employees = [
            { name: 'Bi', birthDate: new Date('12/3/1989'), salary: 15000000, gender: 'Male', status: 'true1'},
            { name: 'Anh', birthDate: new Date('6/15/1990'), salary: 12000000, gender: 'Male', status: 'true1' },
            { name: 'Dung', birthDate: new Date('1/14/1992'), salary: 17000000, gender: 'Male', status: 'false1' },
            { name: 'Cuong', birthDate: new Date('12/3/1993'), salary: 12000000, gender: 'Male', status: 'true1' },
