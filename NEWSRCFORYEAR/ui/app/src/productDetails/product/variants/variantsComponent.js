...
(function () {
    ...
    VariantsController.$inject = ['productApi', '$scope', '$timeout', 'ProductFactory', 'variantsApi',
        'ngTableParams', '$rootScope', 'ProductSearchService', 'imageInfoApi', '$filter', 'DownloadImageService', 'appConstants'];


    function VariantsController(productApi, $scope, $timeout, productFactory, variantsApi, ngTableParams,
                                $rootScope, productSearchService, imageInfoApi, $filter, downloadImageService, appConstants) {
        ...
        self.saveAssignImage = function () {
            ...
            variantsApi.assignImages(data, self.assignImageSuccess, self.fetchError);
        };
        ...
        self.chooseTab = function (tab) {
            ...
            switch (tab) {
                case VARIANTS:
                    ...
                    self.variantsTabPaneClass = 'row tab-pane active';
                    self.variantsItemTabPaneClass = 'row tab-pane';
                ...
                case VARIANTS_ITEM:
                    ...
                    self.variantsItemTabPaneClass = 'row tab-pane active';
                    self.variantsTabPaneClass = 'row tab-pane';
