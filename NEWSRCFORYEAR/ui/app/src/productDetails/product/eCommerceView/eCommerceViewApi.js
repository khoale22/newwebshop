	...
	function eCommerceViewApi(urlBase, $resource) {
		return $resource(
			urlBase, null,
			{
				...
				'getDinnerTonightInformation': {
					method: 'GET',
					url: urlBase + '/pm/productECommerceView/getDinnerTonightInformation',
					isArray: false
				},
				...
				'findWarningsDinnerTonight': {
					method: 'GET',
					url: urlBase + '/pm/productECommerceView/findWarningsDinnerTonight',
					isArray: false
				},
				...
				'findDirectionsDinnerTonight': {
					method: 'GET',
					url: urlBase + '/pm/productECommerceView/findDirectionsDinnerTonight',
					isArray: false
				},
				'findTags': {
					method: 'GET',
				...
				'findIngredientsForDinnerTonight': {
					method: 'GET',
					url: urlBase + '/pm/productECommerceView/findIngredientsForDinnerTonight',
					isArray: false
				},
				...
				'findAllIngredientAttributePrioritiesForDinnerTonight': {
					method: 'GET',
					url: urlBase + '/pm/productECommerceView/findAllIngredientAttributePrioritiesForDinnerTonight',
					isArray: true
				},
				'findDinnerTonightProductDescription': {
					method: 'GET',
					url: urlBase + '/pm/productECommerceView/findDinnerTonightProductDescription'
				},
				'findDinnerTonightTags': {
					method: 'GET',
					url: urlBase + '/pm/productECommerceView/findDinnerTonightTags'
				},
				...
				'updateECommerceViewForDinnerTonight': {
					method: 'POST',
					url: urlBase + '/pm/productECommerceView/updateECommerceViewForDinnerTonight',
				},
				...
				'getDinnerTonightSpecification': {
					method: 'GET',
					url: urlBase + '/pm/productECommerceView/getDinnerTonightSpecification',
					isArray: false
				},
