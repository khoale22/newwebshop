...
public class ImageInfoService {
	...
	public ModifiedEntity<PageableResult<ProductScanImageURI>> getSubmittedImages(List<Long> upcs,
		...
		if (includeCounts) {
			...
			Page<ProductScanImageURI> imageInfoList = this.imageInfoRepositoryWithCount.findSubmittedImageByUpcsAndIncludeRejectedImageOrNot(upcs, isShowRejected, pageRequest);
