...
//	@AuditableField(displayName= "Hazardous Type", filter = {FilterConstants.SHIPPING_HANDLING_AUDIT})
	...
	@AuditableField(displayName = "Guarantee Image", codeTableDisplayNameMethod = "getHebGuaranteeTypeCodeDisplayName", filter = FilterConstants.ONLINE_ATTRIBUTES_AUDIT)
	@NotFound(action = NotFoundAction.IGNORE)
...
//	}
	 ...
	 */
	public String getHebGuaranteeTypeCodeDisplayName(){
