...
public class AuthorizationService {
    ...
    public Map<String, Object> getStores(String userStore){
        ...
        if(StringUtils.isNotBlank(userStore)){
            ...
            retailLocations = retailLocationRepository.findByLinOfBusIdAndKeyLocationNumber(linOfBusId, Integer.valueOf(userStore.trim()));
        }
        if(retailLocations == null || retailLocations.isEmpty()){
            ...
            retailLocations = retailLocationRepository.findByLinOfBusId(linOfBusId);
        }
