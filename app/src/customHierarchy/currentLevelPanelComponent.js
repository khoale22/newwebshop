...
(function () {
	...
	currentLevelPanelController.$inject = ['customHierarchyService', 'CustomHierarchyApi', '$state', 'appConstants', 'ProductSearchService', '$timeout', '$rootScope', '$scope', 'DownloadImageService'];
	 ...
	 * @constructor
	 */
	function currentLevelPanelController(customHierarchyService, customHierarchyApi, $state, appConstants, productSearchService, $timeout, $rootScope, $scope, downloadImageService) {
		 ...
		 */
		function initializeCurrentSelectedTab(){
