...
(function() {
	...
	function productDeleteController(productDiscontinueApi, removeFromStoresApi ,ngTableParams, productInfoService,
		...
		self.NEW_PRODUCT_CONSTANT = "Item has been in HEB systems for 12 months.";
		 ...
		 */
		self.init = function(){
			productSearchService.init(false, true, self.newSearch, null, null);
		...
		self.generateExportUrl = function() {
			...
			switch(self.searchSelectionType){
				...
				case productSearchService.CLASS:
				{
					...
					return urlBase + '/pm/productDiscontinue/exportClassCommodityToCsv?classCode=' + encodeURI(hierarchy.itemClassCode) +
				...
				case productSearchService.COMMODITY:
				{
					...
					return urlBase + '/pm/productDiscontinue/exportClassCommodityToCsv?classCode=' + encodeURI(hierarchy.classCode) +
				...
				case productSearchService.SUB_COMMODITY:
				{
					...
					return urlBase + '/pm/productDiscontinue/exportSubCommodityToCsv?classCode=' + encodeURI(hierarchy.classCode) +
