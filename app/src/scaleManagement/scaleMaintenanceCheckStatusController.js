...
(function() {
	...
	scaleMaintenanceStatusCheckController.$inject = ['$stateParams', 'ngTableParams', 'ScaleMaintenanceApi', '$scope', '$interval'];

	/**
	 * Creates the controller for the scale maintenance loads.
	 */
	function scaleMaintenanceStatusCheckController($stateParams, ngTableParams, scaleMaintenanceApi, $scope, $interval){
		...
		function getRetailData(page) {
			if(self.selectedStoreId){
				scaleMaintenanceApi.checkStatusFindAllRetails({
					transactionId: self.selectedTransactionId,
