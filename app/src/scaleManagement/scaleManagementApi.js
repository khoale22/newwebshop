...
(function () {
	...
	function scaleManagementApi(urlBase, $resource) {
		return $resource(null, null, {
			...
			'getNutrientPanelBySourceSystemReferenceId': {
				method: 'PUT',
                url: urlBase + '/pm/NLEA16NutrientStatement/getNutrientPanelBySourceSystemReferenceId/:sourceSystemReferenceId',
			...
			'checkNLEA16NutrientStatementIsExist': {
				method: 'GET',
				url: urlBase + '/pm/nutrientsStatement/checkNLEA16NutrientStatementIsExist',
				isArray:false
			}
		});
	}
